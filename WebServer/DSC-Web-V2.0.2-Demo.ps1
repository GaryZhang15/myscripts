...
.EXAMPLE
   This example will deploy build version 20150908.4 of webapps lv and an into test environment and send out notification emails.
   Start-Deployment -Environment Test -BuildDefinition test -Version 20150908.4  -WebApp lv,an -SendEmail
.EXAMPLE
    ...
    Begin
        ...
        $webapps = @{
            ...
            allapps = @(
                ...
                # build version folder name and the orgin folder name are diff, orgin name is "iOfficewebsite" while build version name is "OfficialWebSite" 
