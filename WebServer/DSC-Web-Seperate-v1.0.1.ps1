...
<# ***update log ***
 ...
 9-13=2015 v2.1.0
 1. add prod env app path, folder name mapping
...
[CmdletBinding()]
    ...
    Param(
        ...
        [ValidateSet('dsp','bo','fgp','fg','lv','mrp','mr','mg','nbp',
                     'nb','tt','tfp','tf','wwp','ww','an','ah','cg','vh',
                     'cs','dirp','dir','ih','p','pl','dcc','dce',
                     'diag','gbo','mgmt','website','op','gds')]
    ...
    Begin
        {
            ...
            if ($Environment -eq 'Test') {
                $dscEnv = '10.1.1.81'
                Write-Verbose -Message "Delpoyment will be targeted on Test Env Server: 10.1.1.81"
            }
        ...
        $webapps = @{
            ...
            allapps = @(
                        ...
                        @{
                            name = "dsp"	
                            # folder name in prod is DataStatisticsPortal
                ...
                Import-DSCResource -ModuleName xNetworking
                  ...
                  { 
                        ...
                        File WebsitesFolder
                        {
                         ...
                         File WebsitesImageFolder
                        {
                            Ensure = "Present"
                            DestinationPath = 'C:\Websites\iOffice\Images'
                            Type = "Directory"
                         }

                         File WebsitesAudioFolder
                        {
                            Ensure = "Present"
                            DestinationPath = 'C:\Websites\iOffice\Audios'
                            Type = "Directory"
                         }
